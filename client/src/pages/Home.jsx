        ...
        <div className='text-center mb-28'>
            ...
            leading-tight max-w-4xl mx-auto'>
              ...
              <span className='relative inline-block'>
                ...
                rounded-full'>AI Intelligence</span>
              </span>
            </motion.h1>
            <motion.p
            initial={{opacity:0}}
            ...
            [
              ...
              className={`
                ...
                `}>
                  ...
                  bg-white border-2 border-green-500 text-green-600 w-16 h-16 rounded-2xl flex
              ...
              [
                {
                  ...
                  desc:"Tracck progress with performance graph and topic analysis",
                },
              ].map((item,index)=>(
                <motion.div 
                initial={{opacity:0,y:30}}
              ...
              [
                {
                  ...
                  desc:"Deep technical questioning based in selected role.",
                },
                  {
                  image:confidenceImg,
