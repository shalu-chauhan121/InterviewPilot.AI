  ...
  return (
    ...
    bg-gray-200 px-4'>
        ...
        shadow-2xl grid md:grid-cols-2 overflow-hidden'>
            ...
            className='relative bg-green-50 p-12 flex flex-col
            justify-center'>
                 ...
                 <div className='space-y-5'>
                    {
                        [
                            ...
                            space-x-4 bg-white p-4 rounded-xl shadow-sm cursor-pointer'>
                             {item.icon}
            ...
            className='p-12 bg-white'>
                ...
                <div className='space-y-6'>
                    <div className='relative'>
                        ...
                        transition' onChange={(e)=>setRole(e.target.value)} value={role}/>
                    </div>
                     <div className='relative'>
                        <FaBriefcase className='absolute top-4 left-4 text-gray-400'/>
                        <input type='text' placeholder='Experience(eg. 2years)'
                        className='w-full pl-12 pr-4 py-3 border border-gray-200
                        rounded-xl focus:ring-2 focus:ring-green-500 outline-none
                        transition' onChange={(e)=>setExperience(e.target.value)} value={experience}/>
                    </div>
                      <select onChange={(e)=>setMode(e.target.value)} value={mode} className='w-full py-3 px-4 border border-gray-200 rounded-xl
                            ...
                            hover:border-green-500 hover:bg-green-50 transition'>
                                ...
                                {resumeFile &&(
                                    ...
                                    onClick={(e)=>{e.stopPropagation();
                                        e.preventDefault(); handleUploadResume()}}
